	...
	function errh(errorString,exception){
		if(typeof(exception)=="object"){
			if(exception.name == "GD0101"){
				...
				window.open(_application_root, "_TOP");
...
function funPreHook(imageSrc, targetDoc) {
    ...
    if (!disabledImageZone) {
      ...
      disabledImageZone.style.width = _document.body.scrollLeft + _document.body.scrollWidth;
	  disabledImageZone.style.height = _document.body.scrollHeight + _document.body.scrollTop;
      disabledImageZone.style.filter = "alpha(opacity=0)";
      ...
      if(v_imageZone){
      	v_imageZone.style.top =(_document.body.scrollTop+(_document.body.clientHeight-v_imageZone.offsetHeight)/2);
      	disabledImageZone.style.width = _document.body.scrollLeft + _document.body.scrollWidth;
	  	disabledImageZone.style.height = _document.body.scrollHeight + _document.body.scrollTop;
   	    disabledImageZone.style.visibility = 'visible';
