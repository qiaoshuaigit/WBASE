...
<div id="_dropdown_div" align=left>
	<TABLE id="CalendarTable" class="calendar" align=left width=100% cellspacing=0 cellpadding=1 rule=all>
	<TR class="title" valign=top>
		<TD align=left>
		<TABLE WIDTH=100% CELLSPACING=1 CELLPADDING=0>
			<TR>
				<TD align=right><INPUT type=button extra=button value=3
					title="上一年"
					style="FONT-SIZE: 8; FONT-FAMILY: webdings; WIDTH: 18px; HEIGHT: 20px"
					onclick="newChangeCalendarDate(_new_calendarControl.year-1,_new_calendarControl.month)"></TD>
				<TD width=1><INPUT id="_calender_year" type=text class=editor
					size=4 maxlength=4
					onpropertychange="return _new_calendar_year_onpropertychange()"></TD>
				<TD align=left width=20px><INPUT type=button extra=button
					value=4 title="下一年"
					style="FONT-SIZE: 8; FONT-FAMILY: webdings; WIDTH: 18px; HEIGHT: 20px"
					onclick="newChangeCalendarDate(_new_calendarControl.year+1,_new_calendarControl.month)"></TD>
				<TD align=right width=20px><INPUT type=button extra=button
					value=3 title="上个月"
					style="FONT-SIZE: 8; FONT-FAMILY: webdings; WIDTH: 18px; HEIGHT: 20px"
					onclick="newChangeCalendarDate(_new_calendarControl.preYear,_new_calendarControl.preMonth)"></TD>
				<TD width=1><INPUT id="_calender_month" type=text class=editor
					size=2 maxlength=2
					onpropertychange="return _new_calendar_month_onpropertychange()"></TD>
				<TD align=left><INPUT type=button extra=button value=4
					title="下个月"
					style="FONT-SIZE: 8; FONT-FAMILY: webdings; WIDTH: 18px; HEIGHT: 20px"
	...
	<TR class="footer">
		<TD align=left>
			<TABLE><TR><TD>
			<INPUT extra=button type=button id="button_today" value="" onclick="_new_calendar_today_onclick()">
			</TD><TD>
			<INPUT extra=button type=button id="selectBtn" value="确定" onclick="_selectCalender()">
			</TD></TR></TABLE>
		</TD>
	</TR>
</TABLE>
