...
<#list operationsKeys as key>
    ...
    <table id="_tabsetpane_${id}_tabset" align="left" cellspacing="0" cellpadding="0" width="${width}" height="${height}" >
      <tr height="1">
        <td>
          <div id="_tabdiv_${id}_tabset">
            <div id="_tabpane_${id}_tabset" style="width:100%; overflow:hidden; ">
...
-->
<#macro DataTable id   fieldStr="${CommonQueryConfig.toFieldString()}"  width="" height="" readonly="" printabled="true" maxRow="" hasFrame="false">
<#assign tablehead="">
<#assign tablerow="">
...
<#--
       ...
       <#-- yjw 2008-05-26 -->
       <#if fedittype != "hidden">
            <#assign tablehead = tablehead + "\ltd name=\"" + _fId + "\" width=\"" + fwidth + "px\" allowClick=\"true\" allowSort=\"true\" label=\"" + fDesc + "\" \g" + "\l/td\g" >
       </#if>
       <#if fedittype = "select">
              ...
              <#assign tablerow = tablerow + "\ltd name=\"" + _id_name + "\" width=\"" + fwidth + "px\" dataType=\""+ datatype+"\" editorType=\"" + fedittype + "\" dropDown=\"" +_id_DD+"\"  label=\"" + fDesc + "\" nowrap " + "\g"+ "\l/td\g" >
       <#elseif fedittype = "checkbox">
              <#assign tablerow = tablerow + "\ltd name=\"" + _fId + "\" width=\"" + fwidth + "px\" dataType=\""+ datatype+"\"  editorType=\"" + fedittype + "\" label=\"" + fDesc + "\" nowrap " + "\g"+ "\l/td\g" >
...
<table extra="datatable"  skipRebuild="true"  id="${id}"
            ...
            cellspacing="0" cellpadding="0" rules="all" maxRow="${maxRow}">
            <thead>
                <tr height="20px">
                    ${tablehead}
                </tr>
